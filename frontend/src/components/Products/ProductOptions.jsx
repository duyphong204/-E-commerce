  ...
  return (
    <div className="space-y-6 lg:space-y-8">
          ...
          {product.colors?.map((color) => (
            <button
              ...
              className={`w-9 h-9 rounded-full border transition-all duration-300 relative flex items-center justify-center
                ${selectedColor === color ? "ring-2 ring-offset-2 ring-emerald-500 border-transparent scale-110" : "border-gray-200 hover:scale-105"}
      ...
      <div className="border-t border-gray-100 pt-4">
        ...
        <div 
          className={`grid transition-all duration-300 ease-in-out ${isAccordionOpen ? "grid-rows-[1fr] opacity-100 mt-3" : "grid-rows-[0fr] opacity-0"}`}
        >
              ...
              <tbody>
                ...
                {product.gender && (
                  <tr>
                    ...
                    <td className="py-2.5 font-semibold text-gray-800">{product.gender === "Men" ? "Nam giới" : "Nữ giới"}</td>
                  </tr>
                )}
              </tbody>
            </table>
