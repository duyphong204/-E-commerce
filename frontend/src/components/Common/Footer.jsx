            ...
            <div className="container mx-auto px-4 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 pb-12 border-b border-gray-100">
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="flex items-center gap-3">
                            <a href="#" className="w-9 h-9 flex items-center justify-center rounded-full bg-gray-50 text-gray-600 hover:bg-emerald-500 hover:text-white hover:scale-110 active:scale-95 transition-all duration-300">
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-2.5 text-gray-500 text-sm font-medium">
                            <li><Link to="/collections/all?gender=Men" className="hover:text-emerald-500 hover:underline underline-offset-4 transition-colors">Thời Trang Nam</Link></li>
                            <li><Link to="/collections/all?gender=Women" className="hover:text-emerald-500 hover:underline underline-offset-4 transition-colors">Thời Trang Nữ</Link></li>
                            <li><Link to="#" className="hover:text-emerald-500 hover:underline underline-offset-4 transition-colors">Bộ Sưu Tập Mới</Link></li>
                            <li><Link to="#" className="hover:text-emerald-500 hover:underline underline-offset-4 transition-colors">Sản Phẩm Bán Chạy</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-2.5 text-gray-500 text-sm font-medium">
                            <li><Link to="#" className="hover:text-emerald-500 hover:underline underline-offset-4 transition-colors">Liên Hệ Với Chúng Tôi</Link></li>
                            <li><Link to="/about" className="hover:text-emerald-500 hover:underline underline-offset-4 transition-colors">Về Chúng Tôi</Link></li>
                            <li><Link to="#" className="hover:text-emerald-500 hover:underline underline-offset-4 transition-colors">Câu Hỏi Thường Gặp (FAQs)</Link></li>
                            <li><Link to="#" className="hover:text-emerald-500 hover:underline underline-offset-4 transition-colors">Chính Sách Đổi Trả</Link></li>
                        </ul>
                    </div>
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center gap-4 pt-8">
                    ...
                    <div className="flex items-center gap-4 text-xs font-bold text-gray-400">
                        <a href="#" className="hover:text-gray-600 transition-colors">Điều khoản dịch vụ</a>
                        <span>•</span>
