...
const BannerManagement: React.FC = () => {
  ...
  const handleImageUpload = async (e: ChangeEvent<HTMLInputElement>): Promise<void> => {
    ...
    try {
      setUploading(true);
      const res = await axios.post<{ url: string }>(`${import.meta.env.VITE_API_URL}/api/upload`, fd, {
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    min={0}
                  />
                  <p className="text-xs text-blue-600 mt-1.5 bg-blue-50 inline-block px-2 py-1 rounded">
                    💡 Số càng nhỏ, banner càng xuất hiện trước
                  </p>
                </div>
