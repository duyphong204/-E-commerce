...
const BannerManagement = () => {
    ...
    const [formData, setFormData] = useState({ imageUrl: "", title: "", altText: "", order: 0 });
        ...
        <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
            ...
            {banners.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                    {banners.map((b) => (
                        <div key={b._id} className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden group hover:shadow-md transition-all">
                            {/* Ảnh banner */}
                            <div className="relative h-48 bg-gray-100 overflow-hidden">
                                <img 
                                    src={b.imageUrl} 
                                    alt={b.altText || b.title} 
                                    className={`w-full h-full object-cover transition-transform duration-700 group-hover:scale-105 ${!b.isActive && "grayscale"}`} 
                                />
                                {!b.isActive && (
                    ...
                    <div className="bg-white rounded-3xl shadow-xl max-w-xl w-full max-h-[90vh] overflow-y-auto scale-in-center">
                        <div className="p-6 sm:p-8">
                            <div className="flex items-center justify-between mb-6">
                                <h2 className="text-2xl font-bold text-gray-900">{editingBanner ? "Chỉnh sửa Banner" : "Tạo Banner Mới"}</h2>
                                <button onClick={closeModal} className="p-2 bg-gray-50 text-gray-500 hover:text-gray-800 hover:bg-gray-100 rounded-full transition-colors">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-5">
                                ...
                                <div>
                                    ...
                                    {uploading && <p className="text-sm text-blue-600 mt-2 font-medium animate-pulse">Đang upload ảnh lên hệ thống...</p>}
                                    {formData.imageUrl && (
                                ...
                                {/* Alt Text */}
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1.5">Mô tả SEO (Alt Text)</label>
                                    <input 
                                        type="text" 
                                ...
                                <div>
                                    ...
                                    <input 
                                        ...
                                        min={0} 
                                    />
                                    <p className="text-xs text-blue-600 mt-1.5 bg-blue-50 inline-block px-2 py-1 rounded">💡 Số càng nhỏ, banner càng xuất hiện trước</p>
                                </div>
