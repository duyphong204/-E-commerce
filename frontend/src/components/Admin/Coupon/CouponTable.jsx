                                ...
                                <td className="py-4 px-5">
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <div className="text-xs text-gray-500 flex flex-col gap-0.5">
                                            {coupon.minOrderValue > 0 && <span>Min: {Number(coupon.minOrderValue).toLocaleString("vi-VN")}đ</span>}
                                            {coupon.discountType === "percent" && coupon.maxDiscountValue > 0 && <span>Max: {Number(coupon.maxDiscountValue).toLocaleString("vi-VN")}đ</span>}
                                        </div>
                                    </div>
                                </td>
                                <td className="py-4 px-5">
