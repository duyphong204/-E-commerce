...
import { Users, UserCog, User, Trash2, Plus, ShieldCheck } from "lucide-react";
                ...
                <div className="overflow-x-auto">
                    ...
                    <tbody className="divide-y divide-gray-100 text-gray-700">
                        ...
                        users.map((userItem, index) => (
                            ...
                            <td className="py-4 px-6 font-medium text-gray-500">{(page - 1) * 10 + (index + 1)}</td>
                            <td className="py-4 px-6">
                                <div className="flex flex-col">
                                    ...
                                    <span className="text-gray-400 text-xs mt-0.5">
                                        Tham gia: {new Date(userItem.createdAt).toLocaleDateString("vi-VN")}
                                    </span>
                                </div>
                            </td>
                            <td className="py-4 px-6">
