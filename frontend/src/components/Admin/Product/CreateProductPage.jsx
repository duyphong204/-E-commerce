...
import { ArrowLeft, Upload, Package, AlignLeft, DollarSign, Tag, Archive, Layers, Hash, Image as ImageIcon, Save, CheckCircle2 } from 'lucide-react'
  ...
  return (
    <div className='max-w-6xl mx-auto p-4 sm:p-6 lg:p-8'>
        ...
        <div className="flex items-center gap-4 mb-8">
            ...
            <div>
                <h2 className='text-2xl sm:text-3xl font-bold text-gray-900 mb-1'>Thêm Sản Phẩm Mới</h2>
                <p className="text-gray-500 text-sm">Điền đầy đủ thông tin bên dưới để tạo sản phẩm mới</p>
            </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-3">
                                {["Top Wear", "Bottom Wear", "Footwear", "Accessories"].map((cat) => (
                                    <label key={cat} className={`relative flex items-center justify-center px-4 py-2.5 border rounded-xl cursor-pointer transition-all
                                        ${productData.category === cat ? 'bg-blue-50 border-blue-200 text-blue-700 font-medium' : 'bg-white border-gray-200 text-gray-600 hover:bg-gray-50'}`}>
                                        <input
                                            type="radio"
                                            name="category"
                                            value={cat}
                                ...
                                {["Men", "Women", "Unisex"].map((g) => (
                                    <label key={g} className="flex items-center gap-2 cursor-pointer group">
                                        <div className={`w-5 h-5 rounded-full border flex items-center justify-center transition-colors
                                            ${productData.gender === g ? 'border-blue-500 bg-blue-500' : 'border-gray-300 bg-white group-hover:border-blue-400'}`}>
                                        ...
                                        <input
                                            ...
                                            required
                                        />
                                        <span className={`text-sm ${productData.gender === g ? 'text-gray-900 font-medium' : 'text-gray-600'}`}>{g}</span>
                                    </label>
                                ))}
                            </div>
                        </div>
            ...
            <div className="space-y-8">
                ...
                <div className="sticky top-8">
                    ...
                    >
                        <Save className="w-5 h-5" /> Thêm Sản Phẩm Mới
                    </button>
                </div>
            </div>
        </form>
