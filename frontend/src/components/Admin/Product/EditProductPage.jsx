...
import { ArrowLeft, Upload, Package, AlignLeft, DollarSign, Tag, Archive, Layers, Hash, Image as ImageIcon, Save, CheckCircle2, XCircle } from 'lucide-react'
...
const EditProductPage = () => {
    ...
    const handleImageUpload = async (e) => {
        ...
        try {
            ...
            // thiết lập lại đầu vào để có thể chọn lại các tệp tương tự nếu cần
            e.target.value = null;
        } catch (error) {
    ...
    if (error) return <div className="text-center text-red-500 p-8">Lỗi : {error}</div>
